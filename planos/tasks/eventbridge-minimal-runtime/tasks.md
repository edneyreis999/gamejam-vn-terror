...
This graph was authored on 2026-09-12 against base `5d0d9ab0296e7150cfbdd7ab263d304eeab06fdb` and the existing approved working-tree spec set. It contains **14 implementation tasks and one ordered QA planning/execution pair**. Execution started on 2026-09-12 at the user’s request. Tasks 01–14 have their assigned technical evidence. All planned technical sensors are verified; task15 is complete and task16 is blocked only on four assigned human judgments and subsequent accepted-delivery media organization.
...
| V-003 | 16 | 01–06, 14 | S03; native editor, replacement CE and non-JavaScript author acceptance |
...
| V-009 | 16 | 02, 09, 10, 11 | S07; AUTO/FAST and per-campaign reading eligibility |
...
- CommonEvents.json currently ends at CE81; variables exist through 146. Maps 001–036 and relevant CE groups were inspected. Map004, maps 007–022, Map023 and maps 025–036 currently enter shared CE40; tasks 04/05/06/13 must migrate its matching phase branches as well as their map entries. CE41 contains deaths/farewells/opinions/epilogues; CE58 contains memorial prose. Task 01 creates the missing Configuração do jogo map path to CE4 or its replacement. These are dated inventory facts, not permanent allocation constants. Append new CEs and preserve unrelated IDs/MapInfos hierarchy.
