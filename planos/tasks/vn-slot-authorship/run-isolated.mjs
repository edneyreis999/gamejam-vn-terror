...
const root = process.cwd(), work = await mkdtemp(path.join(tmpdir(), 'dryland-native-slots-'));
const out = path.join(root, 'docs/qa/evidence/vn-slot-authorship', `task-${task}`, new Date().toISOString().replace(/[:.]/g, '-'));
