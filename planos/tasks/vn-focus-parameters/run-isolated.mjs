...
const root = process.cwd(), work = await mkdtemp(path.join(tmpdir(), 'dryland-focus-parameters-'));
const out = path.join(root, 'docs/qa/evidence/vn-focus-parameters', `task-${task}`, new Date().toISOString().replace(/[:.]/g, '-'));
