...
- **Como aprendeu:** passou anos trabalhando em silêncio, escuridão e espaços apertados, onde o pânico de uma pessoa podia colocar toda a equipe em perigo.
- **Uma situação em que já usou essa capacidade:** depois de um desabamento, permaneceu consciente durante horas e manteve duas colegas calmas até a abertura de uma passagem de resgate.
- **Uma pista visível ou comportamental:** quando sente medo, conta lentamente as próprias respirações e nomeia em voz alta apenas aquilo que sabe ser real.
- **Uma fala que sugere a competência:** “O medo faz eco. Escute uma vez; não responda.”

### Competência 2 — Sobrevivência

- **Como aprendeu:** aprendeu a reconhecer ar ruim, água subterrânea, pedra instável e rotas seguras trabalhando em minas pouco confiáveis.
- **Uma situação em que já usou essa capacidade:** encontrou uma saída secundária seguindo a corrente de ar depois que a entrada principal de uma galeria desabou.
- **Uma pista visível ou comportamental:** verifica o chão, a umidade, o vento e os sons do ambiente antes de escolher uma passagem.
- **Uma fala que sugere a competência:** “Ar frio vindo de baixo. Há outra saída por aqui.”

### Atenção às competências físicas

Draska não resolve obstáculos por potência bruta, velocidade ou manipulação delicada. Sua Sobrevivência permite interpretar o ambiente e encontrar meios seguros de atravessá-lo; sua Vontade permite resistir ao medo e à manipulação.

---

## 4. Personalidade e voz

- **Melhor qualidade:** percebe perigos cedo e compartilha o que sabe sem tentar parecer heroica.
- **Principal defeito:** tem dificuldade de seguir um plano quando não controla ou compreende todas as variáveis.
- **Maior medo:** ficar presa sem conseguir conduzir outras pessoas para fora.
- **Como reage sob pressão:** observa o ambiente, separa fatos de suposições e propõe a opção com menor risco imediato.
- **Como demonstra carinho ou amizade:** prepara discretamente água, comida e equipamento extra para a pessoa.
- **Jeito de falar:** seco, preciso e prático; usa comparações com pedra, túneis, ar e sustentação.
...
- **Elemento que a diferencia dos outros heróis:** marca discretamente paredes e portas com traços de giz, criando um registro visual do caminho percorrido.
