...
area: CAM
title: Concluir ambas as ordens e os três desfechos
...
retest_status:
fix_commits:
evidence: docs/qa/evidence/2026-09-05-prototype-v2-gdd-layouts/native-final-solo.json; docs/qa/evidence/2026-09-05-prototype-v2-gdd-layouts/native-final-total-loss.json; docs/qa/evidence/2026-09-05-prototype-v2-gdd-layouts/native-reverse-destroy.json; docs/qa/evidence/2026-09-05-prototype-v2-gdd-layouts/native-destroy-with-deaths.json; docs/qa/evidence/prototype-v2-gdd-layouts/supervisor-keyboard-zoom/summary.json
...
Cada desfecho deve permanecer em Campanha concluída até Jogar novamente; o retorno mostra avisos e limpa seed, texto visto, mortes, rotas, recompensas e histórico. Evidência histórica permanece nos relatórios, sem valer como veredito atual.
