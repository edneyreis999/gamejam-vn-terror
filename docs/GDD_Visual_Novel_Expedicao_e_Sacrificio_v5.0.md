...
**Autoridade:** `GDD_Visual_Novel_Expedicao_e_Sacrificio.md`, sem sufixo, é a fonte de verdade atual. O snapshot `GDD_Visual_Novel_Expedicao_e_Sacrificio_v5.0.md` registra o mesmo conteúdo na data de criação e torna-se histórico quando o canônico voltar a evoluir.
...
- [GDD v4.0](./GDD_Visual_Novel_Expedicao_e_Sacrificio_v4.0.md)
...
Deixou para Ivaí a primeira metade do medalhão, uma genealogia, relatos contraditórios e o aviso de não envolver outras pessoas. Seus documentos não provam qual dos dois efeitos do artefato é verdadeiro. Os registros entram no prólogo, após obter a primeira peça do mapa e durante a revelação final. Na abertura da versão 5.0, Rheed menciona lembranças e uma tradição familiar sem ler um excerto literal; o aviso está incorporado à sua apresentação. Os dois momentos posteriores permanecem como antes (seção 27).
...
1. **Prólogo:** Rheed mais velho narra a apresentação dos registros incompletos de Irati e a busca pelo tesouro perdido da família de Ivaí. Revela o recrutamento apesar do aviso materno; maldição, medalhão e plano continuam ocultos. Os mapas/documentos são descritos, sem imagens. Os destinos são nomeados apenas na preparação. A troca pública entre Rheed jovem e Ivaí encerra a cena sem interpretação (seção 27).
...
**Confirmado:** prólogo breve, sem duração rígida. Ivaí deve parecer persuasivo e convincente; as anotações de Irati sustentam a ligação verdadeira da família com o destino. A curiosidade vem dos registros e mapas incompletos, admitidos sem muitos esclarecimentos, e da descrição vaga do tesouro. A inquietação fica nas entrelinhas. Confiança e curiosidade são intenções editoriais, sujeitas à interpretação do jogador.

Sequência: apresentação breve de Rheed mais velho → chegada dos oito à taverna e registros de Irati → lembranças, tradição familiar e mapas incompletos → promessa direta de Ivaí → pergunta de Rheed jovem → resposta de Ivaí → preparação do grupo. Os oito estão presentes, sem falas nem reações mostradas. Os destinos são nomeados somente na preparação; os mapas iniciais não substituem as duas peças obtidas posteriormente.

**Confirmado por decisão explícita:** preservar “a contragosto de Irati” e o relato de que Ivaí insistiu no recrutamento apesar do aviso materno. O usuário manteve a redação após discutir seus riscos de sugerir Irati viva e antecipar desconfiança. A morte de Irati dois anos antes continua vigente; não se criou outra cronologia. A ambiguidade aceita prevalece sobre a intenção anterior de evitar toda suspeita inicial.

### 27.2 Rheed

**Confirmado como enquadramento narrativo:** Rheed é um anão que, jovem, auxiliava Ivaí nos afazeres cotidianos e distribuiu os anúncios da expedição sob suas ordens. Conhece o objetivo de quebrar a maldição do afogamento e se preocupa com Ivaí; o prólogo não explica essa preocupação. Sua pergunta final alude à omissão sem nomear a maldição.

Rheed mais velho conta o que viveu quando jovem, com voz próxima e coloquial, respeitando o conhecimento de cada momento, sem antecipar descobertas. Seu conhecimento prévio da maldição é omitido na abertura. Rheed jovem acompanha as expedições como ajudante e testemunha, fora das vagas dos três heróis e sem ações ou habilidades controladas pelo jogador. Não resolve armadilhas, não pode ser sacrificado e não é um nono herói selecionável. Pode ser o único sobrevivente após a morte dos oito heróis e de Ivaí, permitindo o relato posterior; isso não impede o game over.

**Fora do escopo desta entrega:** converter a narração das outras cenas, reescrever finais ou implementar novas cenas para essa presença. O enquadramento orienta entregas futuras; somente o prólogo muda agora.

### 27.3 Texto e subtexto

**Confirmado para esta entrega:** seguir o roteiro vinculado. A descrição dos documentos usa: “Os papéis eram de Irati, mãe dele. Entre as anotações, havia lembranças da família, a descrição de uma tradição passada por gerações e referências àquele lugar que procurávamos.”

**Fora do escopo:** descrever a tradição específica. Não há leitura de trecho por escrever nem marcador de conteúdo faltante no jogo. O excerto antigo “Não leve outras pessoas para pagar uma dívida que não escolheram” deixa de ser um trecho independente; o aviso já está incorporado à apresentação de Rheed.

**Baseline de protótipo — promessa aceita por enquanto:** Ivaí diz “Minha família deixou as pistas. Vocês trazem a experiência para seguirmos por elas. O que encontrarmos, repartiremos entre nós.” Não acrescentar reserva de recompensa nem detalhar o tesouro.

**Confirmado — encerramento:** Rheed jovem pergunta, audível para todos: “Você não está esquecendo de nenhuma informação, mestre?” Ivaí responde: “Os detalhes serão adicionados ao longo do caminho.” Após o avanço do jogador, encerrar imediatamente, sem reações ou comentários interpretativos.

### 27.4 Apresentação e dependências
