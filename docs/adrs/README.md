...
A [ADR-003 de `revised-trap-prose-integration`](../../planos/tasks/revised-trap-prose-integration/adrs/adr-003-proportionate-prose-verification.md), aceita em 2026-09-22, registra a dispensa explícita e local de integração/E2E/controles/Continue e segunda resolução para essa edição de prosa. Substitui nesse recorte a exigência de E2E de G006, mantendo conferência estática e inspeção visual. Também registra a diretiva de saves próprios em SD-015.
