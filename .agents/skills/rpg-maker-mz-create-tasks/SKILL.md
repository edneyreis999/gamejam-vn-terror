...
Transport the approved execution mode/reference, variants and evidence dependencies into each task. Assign fixture preparation and proof of observability to the task that owns the behavior; QA consolidates remaining gaps.
