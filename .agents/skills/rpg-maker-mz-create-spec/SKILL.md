...
Record sensor separately from execution mode. Browser gameplay uses directed-browser; other sensors use their own method. Carry required variants, expected-result authority, reusable evidence and invalidation dependencies in the existing scenario table.
