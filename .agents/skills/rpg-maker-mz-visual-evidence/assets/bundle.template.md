...
- Reference provenance/dependencies: <original run, hashes, sensor and equivalence rationale>
- Capture kind: <stable state / timestamped sequence and assigned claim>
